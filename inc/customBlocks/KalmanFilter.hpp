...
public:
    ...
    eeros::control::Input<double> &getU(uint8_t index)
    {
        ...
        {
            throw eeros::Fault("Trying to get inexistent element of system input vector u in Block " +
                                                        this->getName() + ".");
        }
    ...
    eeros::control::Input<double> &getY(uint8_t index)
    {
        ...
        {
            throw eeros::Fault("Trying to get inexistent element of system output vector y in Block " +
                                                        this->getName() + ".");
        }
    ...
    eeros::control::Output<double> &getX(uint8_t index)
    {
        ...
        {
            throw eeros::Fault("Trying to get inexistent element of system state vector x in Block " +
                                                        this->getName() + ".");
        }
        return out[index];
    }
